            ...
            <form action="{{ url('/login') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error("email") {{ 'is-invalid' }} @enderror" name="email" id="email" placeholder="Masukkan E - Mail" value="{{ old('email') }}">
                    </div>
                    @error("email")
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control @error("password") {{ 'is-invalid' }} @enderror" name="password" id="password" placeholder="Masukkan Password" required data-eye>
                    </div>
                    @error("password")
                    <span class="text-danger">
                        {{ $message }}
