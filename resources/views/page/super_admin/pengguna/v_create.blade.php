...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="panel panel-headline">
            ...
            <form action="{{ url('/super_admin/data_pengguna/store') }}" method="POST">
                @csrf
                <div class="panel-body">
                    ...
                    <div class="form-group @error("email") {{ 'has-error' }} @enderror">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Masukkan E-Mail" value="{{ old('email') }}">
                            </div>
                        </div>
                        @error("email")
                            <span class="text-danger">
